 ...
 */
private[websocket] object Base64 {

  private val chars = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"

  @tailrec
  private def encode(bytes: List[Byte], acc: List[Char]): String = bytes match {
    case b1 :: b2 :: b3 :: rest =>
  ...
  def encode(str: String): String =
    encode(str.getBytes.toList, Nil)

  @tailrec
  private def decode(characters: List[Char], acc: List[Byte]): String = characters match {
    case c1 :: c2 :: '=' :: '=' :: _ =>
